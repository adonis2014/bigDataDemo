...
package com.seven.test.storm;

import java.util.Arrays;
import java.util.Map;

import com.seven.test.util.Constant;
...
public class KafkaStormHdfsTopology {
    ...
    public static class KafkaWordToUpperCase extends BaseRichBolt {
        ...
        public void execute(Tuple input) {
            ...
            LOG.info("=========>KafkaWordToUpperCase RECV[kafka -> splitter] " + line);
            if (!line.isEmpty()) {
                String upperLine = line.toUpperCase();
                LOG.info("=========>KafkaWordToUpperCase EMIT[splitter -> counter] " + upperLine);
    ...
    public static class RealtimeBolt extends BaseRichBolt {
        ...
        public void execute(Tuple input) {
            String line = input.getString(0).trim();
            LOG.info("==========>RealtimeBolt REALTIME: " + line);
            collector.ack(input);
        }
    ...
    public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException,
        ...
        FileNameFormat fileNameFormat = new DefaultFileNameFormat().withPath("/stormtohdfs2/")
            .withPrefix("app_").withExtension(".log");// set file name format
        HdfsBolt hdfsBolt = new HdfsBolt().withFsUrl("hdfs://127.0.0.1:9000")
        ...
        String name = KafkaStormHdfsTopology.class.getSimpleName();
